	...
	public boolean performMutation(MutationLocation location) {
		...
		for(int i=0; i < lines.size(); i++){
			...
			if(i == location.getLine()){
				...
				switch(type){
				case ArgumentMutationLocation.INT:	argVal = ""+IntegerGenerator.generateRandomInt();
				break;
				...
				break;
				case ArgumentMutationLocation.STRING:	argVal = ""+StringGenerator.generateRandomString();
				break;
				}
